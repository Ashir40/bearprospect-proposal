...
const metrics = [
  { label: "Outreach Volume", current: "5-10/week", projected: "200-400/week", improvement: "40x", icon: <Zap className="h-5 w-5" /> },
  { label: "Research Time / Prospect", current: "30-45 min", projected: "0 min", improvement: "100%", icon: <Clock className="h-5 w-5" /> },
  { label: "Reply Rate", current: "2-3%", projected: "8-15%", improvement: "5x", icon: <Target className="h-5 w-5" /> },
  { label: "Meetings / Month", current: "1-2", projected: "15-25", improvement: "15x", icon: <Calendar className="h-5 w-5" /> },
  { label: "BD Focus on Closing", current: "30%", projected: "100%", improvement: "3x", icon: <Eye className="h-5 w-5" /> },
  { label: "Pipeline Visibility", current: "Minimal", projected: "Full Analytics", improvement: "Complete", icon: <TrendingUp className="h-5 w-5" /> },
];

const strategicValues = [
  { icon: <Zap className="h-6 w-6" />, title: "Fill the Pipeline", description: "Autonomous lead gen running 24/7 — no manual research, no missed opportunities." },
  { icon: <Package className="h-6 w-6" />, title: "Productize It", description: "BearProspect becomes a standalone SaaS product sold to other B2B tech companies." },
  { icon: <Shield className="h-6 w-6" />, title: "Living Demo", description: "The system itself is a live proof of Bearplex's autonomous agent expertise." },
  { icon: <TrendingUp className="h-6 w-6" />, title: "Competitive Moat", description: "Proprietary sales intelligence that improves with every interaction — impossible to replicate." },
];
