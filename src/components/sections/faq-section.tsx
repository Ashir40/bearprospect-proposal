...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Because Bearplex literally has two people for all of business development — Ashir and Awais. That's it. And right now, both of them are fully occupied managing Upwork: writing proposals, responding to invites, handling client conversations on the platform. There's no one left to do outbound prospecting, and there's no system in place for inbound either — no lead magnets, no automated sequences, no pipeline outside of Upwork. The irony is that Ashir and Awais are proven closers. They've landed enterprise deals, built long-term client relationships, and have the experience to convert high-value leads. The talent to close is there — what's missing is the pipeline feeding them leads. Bearplex doesn't have a closing problem, it has a sourcing problem. BearProspect solves this by becoming the system that Bearplex has never had — an autonomous engine that handles both inbound and outbound, discovers qualified prospects, researches them deeply, runs personalized multi-channel outreach, and delivers warm, pre-qualified leads directly to Ashir and Awais. They stop spending their days writing Upwork proposals and start spending them on discovery calls with CTOs who already know what Bearplex does.",
  },
  {
